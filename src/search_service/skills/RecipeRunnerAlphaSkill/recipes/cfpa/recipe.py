...
from ...specs.datasource_specs.cfpa_datasource_spec import adls_data_source_spec
...
proccessing_control = ADLSProcessingControl(
    ...
    included_directories=["General", "IR - Analyst Reports", "Competitive Analysis Events", "Competitive Analysis Database"],
    excluded_directories=[]
)

cfpa_processing_recipe = MultiProcessingRecipe(
    id="recipe_001",
